...
public class EnemyBullet : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3 targetTemp = new Vector2(target.transform.position.x, target.transform.position.y + 1);
        Vector2 moveDir = (targetTemp - transform.position).normalized * bulletSpeed;
